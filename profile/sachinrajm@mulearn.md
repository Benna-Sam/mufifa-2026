...
- Representing **Argentina** in μFIFA, because they embody the idea that a team with deep tactical identity and relentless belief can outplay anyone. That philosophy maps directly to how I think about building programs and teams at μLearn.

#### Supporting Team in the Real World Cup 2026:

- Argentina, all the way. The loyalty doesn't split.

#### All-Time Favourite Player:

- **Lionel Messi**, not just for the records, but for what the 2022 Qatar campaign meant. A player who kept showing up for a decade of near-misses and finally lifted the trophy on his own terms. That kind of persistence over a long arc is what I find genuinely inspiring.

#### Best Player Right Now:

- **Vinicius Jr.**, known for pace, creativity, and a competitive edge that raises the level of everyone around him. He's the most complete attacking player in the world right now.
...
- **Winner:** Argentina to defend, as the squad still has the spine and the experience.
...
- **Most anticipated match:** Argentina vs France, if it happens in the knockouts. A rematch of 2022 final is the game everyone wants.

#### μFIFA World Cup 2026 - Tournament Goals:

- Build and ship a working leaderboard helper tool and task verification pipeline for μFIFA before the Grand Final.
...
- 💻 **Coder**: [GitHub: sachin-raj-m](https://github.com/sachin-raj-m)
- 📋 **Strategist**: [LinkedIn: sachinrajm](https://www.linkedin.com/in/sachinrajm)
...
- BTech in Artificial Intelligence and Data Science from Jyothi Engineering College, Cheruthuruthy.
- Certifications: Google Project Management Professional, McKinsey.org Forward Program, and IIT Kharagpur's Introduction to Machine Learning.
- GitHub: [sachin-raj-m](https://github.com/sachin-raj-m)
- LinkedIn: [sachinrajm](https://www.linkedin.com/in/sachinrajm)
...
- Collaborated with GTech representatives and industry partners to support Education 4.0 initiatives.
- Engaged with student groups and startup hubs, helping connect recruiting teams with students.
